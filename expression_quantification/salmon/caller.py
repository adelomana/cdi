...
def salmon_caller(label):
    ...
    executable='time /proj/omics4tb2/alomana/software/salmon-latest_linux_x86_64/bin/salmon quant'
...
threads = 64
results_dir = '/proj/omics4tb2/alomana/projects/cdi/results/salmon/'
transcriptome_index = '/proj/omics4tb2/alomana/projects/cdi/data/mmrf_annotation/salmon.index'
gtf_file = '/proj/omics4tb2/alomana/projects/cdi/data/mmrf_annotation/Homo_sapiens.GRCh37.74.gtf.hs37d5.EGFRvIII.gtf'
